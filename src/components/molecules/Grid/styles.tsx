...
<{ align?: string; pdd?: string; mgLeft?: string; txtAlign?: string; fontSize?: string; fontFamily?: string; color?: string; bg?: string; wdt?: string; hgt?: string; mgTop?: string; dir?: string; bdRd?: string }>
`
    overflow: hidden;
