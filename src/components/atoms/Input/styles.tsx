...
export const TextInputStyle = styled.TextInput
    <{ bgColor?: string; align?: string; placeColor?: string; color?: string; fontFamily?: string; bdRd?: string; fontSize?: string; wdt?: string; hgt?: string; pddLeft?: string; mgTop?: string; mgLeft?: string; wrap?: string }>
`
